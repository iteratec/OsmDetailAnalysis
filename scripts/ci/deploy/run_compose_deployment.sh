...
echo "####################################################"
echo "PASSWORD_seu_jenkins_iteratec@osm-hosts=${SEU_JENKINS_ITERATEC_AT_OSM_HOSTS_PASSWORD}"
echo "USERNAME_seu_jenkins_iteratec@osm-hosts=${SEU_JENKINS_ITERATEC_AT_OSM_HOSTS_USERNAME}"
